...
public class AddressDaoImpl implements AddressDao {
    ...
    public Address selectDefaultAddress(int uid) {
        Address address = null;
        String sql = "select a_id as aid,u_id as uid,a_name as aname,a_phone as aphone,a_detail as adetail,a_state as astate from address where u_id =? and a_state='1'";
        try {
